...
lib/notebooks/
  ...
  image_samples/                 # shared CIFAR-10 index JSONs
```
...
| [`heatmap_defense_improvements/`](heatmap_defense_improvements/) | 2026-07-18 | **Done for now.** Ablations to close the Attn-last gap; keep [`cc_bbox_blur/`](heatmap_defense_improvements/cc_bbox_blur/) (**74.9%** mean, clean Δ −1.5pp). See [`README.md`](heatmap_defense_improvements/README.md). | per-subfolder `results/` |
| [`four_lang_cc_bbox_blur/`](four_lang_cc_bbox_blur/) | 2026-07-18 | Initial trial: does EN/ZH winner **`cc_bbox_blur`** transfer to KO/JA? For each partner L∈{zh,ko,ja}: uni-EN / uni-L / multi EN+L dual-box attacks; defend with EN∩L Attn-last → CC+bbox+blur. See [`README.md`](four_lang_cc_bbox_blur/README.md). | `results/{L}/{attack}/`, `comparison_summary.json` |
