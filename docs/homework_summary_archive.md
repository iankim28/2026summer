...
1. **Part D** — July 25 (gated `cc_bbox_black`, fill ranking, DP chase, partner fills, hybrids)
2. **Part C** — July 20–24 (frozen protocol, detector gate, baselines, MIXED2000)
3. **Part A** — July 16–19 defense sprint (`cc_bbox_blur`, 4-lang, KO/JA clean Δ)
4. **Part B** — July 5 Assignment 1–2 (JA model swap, 4×4 attack matrix)
