# Homework Summary (July 5 assignments — archived)

**Project:** Thread B — 4 separate CLIP models (EN, ZH, KO, JA) evaluated against typographic adversarial attacks on CIFAR-10.

> Superseded as the main briefing file by [`homework_summary.md`](homework_summary.md) (July 16–19 defense progress). Kept here for Assignment 1–2 reference.
